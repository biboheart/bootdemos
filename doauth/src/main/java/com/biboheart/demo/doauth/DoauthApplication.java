package com.biboheart.demo.doauth;
...
@Slf4j
public class DoauthApplication implements ApplicationListener<ContextRefreshedEvent> {
    public static void main( String[] args ) {
        SpringApplication.run(DoauthApplication.class, args);
    }
