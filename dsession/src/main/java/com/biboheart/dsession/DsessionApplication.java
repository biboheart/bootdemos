package com.biboheart.dsession;
...
@Slf4j
public class DsessionApplication implements ApplicationListener<ContextRefreshedEvent> {
    public static void main(String[] args) {
        SpringApplication.run(DsessionApplication.class, args);
    }
