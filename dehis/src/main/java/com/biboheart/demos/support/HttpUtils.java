...
public class HttpUtils {
    public static <T> T getResult (Object data, Class<T> valueType) {
        ...
        String str = (data instanceof String) ? String.valueOf(data) : JsonUtils.obj2json(data);
        ...
        return objectMapper.convertValue(JsonUtils.json2obj(str, valueType), valueType);
    }
    ...
    public static Resource request(RestTemplate restTemplate,
                                   String url,
                                   HttpMethod method,
                                   HttpHeaders headers,
                                   Object params) throws BhException {
        if (null == headers) {
        ...
        ResponseEntity<Resource> response = restTemplate.exchange(url, method, request, Resource.class);
